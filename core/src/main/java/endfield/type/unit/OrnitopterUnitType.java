...
public class OrnitopterUnitType extends UnitType2 {
	...
	public <T extends Unit & Ornitopterc> void drawBlade(T unit) {
		...
		for (int sign : Mathf.signs) {
			long seedOffset = 0;
			for (BladeMount mount : unit.blades()) {
	...
	public void draw(Unit unit) {
		...
		if (unit instanceof Ornitopterc) {
			drawBlade((Unit & Ornitopterc) unit);
		}
	}
